...
//         userID="98765" // userID can be something like a phone number or the user id on your own user system.
//         userName="phwrithish"
//         conferenceID="123456789" // conferenceID can be any unique string.
//         config={{
//           onLeave: () => {
